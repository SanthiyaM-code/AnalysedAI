...
public class NavAdapter extends RecyclerView.Adapter<com.example.analysed.NavViewHolder> {
    ...
    @Override
    public com.example.analysed.NavViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater inflater=LayoutInflater.from(parent.getContext());
        View view=inflater.inflate(R.layout.nav_view,parent,false);
        return new com.example.analysed.NavViewHolder(view);
    }

    @Override
    public void onBindViewHolder(com.example.analysed.NavViewHolder holder, int position) {
